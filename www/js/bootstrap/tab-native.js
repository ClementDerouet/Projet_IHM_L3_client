...
var Tab = function (element, options) {
  ...
  clickHandler = function (e) {
    ...
    e[preventDefault]();
    next = e[target][getAttribute](dataToggle) === component || href && href.charAt(0) === '#' ? e[target] : e[target][parentNode]; // allow for child elements like icons to use the handler
